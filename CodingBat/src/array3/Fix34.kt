...
fun main() {
    println(fix34(arrayOf(1, 3, 1, 4)).contentToString())
    println(fix34(arrayOf(1, 3, 1, 4, 4, 3, 1)).contentToString())
    println(fix34(arrayOf(3, 2, 2, 4)).contentToString())
}

fun fix34(nums: Array<Int>): Array<Int> {
