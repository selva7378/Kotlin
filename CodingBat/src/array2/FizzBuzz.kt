 ...
 *is a little more complicated than the usual version since you have to allocate and index into
...
fun main() {
    println(fizzBuzz(1, 6).contentToString())
    println(fizzBuzz(1, 8).contentToString())
    println(fizzBuzz(1, 11).contentToString())
    println(fizzBuzz(13, 16).contentToString())
}

fun fizzBuzz(start: Int, end: Int): Array<String> {
    val arr = Array<String>(end - start) { "" }
    var start = start
