...
fun main() {
    println(fizzArray3(5, 10).contentToString())
    println(fizzArray3(11, 18).contentToString())
    println(fizzArray3(1, 3).contentToString())
}

fun fizzArray3(start: Int, end: Int): Array<Int> {
    val arr = Array<Int>(end - start){0}
